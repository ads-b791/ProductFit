(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".how__slider")) new core(".how__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".platforms__slider")) new core(".platforms__slider", {
        ...
        if (document.querySelector(".laptop__slider")) new core(".laptop__slider", {
